...
def evaluate_model(model,test_loader):
    ...
    checkpoint = torch.load("convnext_small_model_tam.pth", map_location=config["device"])
    model.load_state_dict(checkpoint["model_state_dict"])
    ...
    df_report.to_csv("convSmall.csv", index=True)
...
if __name__ == "__main__":
    ...
    checkpoint = torch.load('convnext_small_model_tam.pth', map_location='cpu')
