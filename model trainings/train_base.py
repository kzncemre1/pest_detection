...
config = {
    ...
    'model_save_path': 'convnext_base_model_tam.pth',
...
def load_datasets():
    ...
    train_loader = DataLoader(get_partial_dataset(train_dataset), 12, shuffle=True, num_workers=config['num_workers'])
    val_loader = DataLoader(get_partial_dataset(val_dataset), 12, shuffle=False, num_workers=config['num_workers'])
    test_loader = DataLoader(get_partial_dataset(test_dataset), 12, shuffle=False, num_workers=config['num_workers'])
...
def evaluate_model(model,test_loader):
    ...
    df_report.to_csv("convBase.csv", index=True)
